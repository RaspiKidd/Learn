...
const FeatureList: FeatureItem[] = [
  {
    ...
    Svg: require('@site/static/img/Scratch.svg').default,
    description: (
      <>
        Scratch Code Club training guide
      </>
    ),
    Label: 'Scratch Training',
    src: '/docs/Scratch-Training/Overview'
  },
  /*{
    title: 'EduBlocks',
...
export default function TrainingFeatures(): ReactNode {
  return (
